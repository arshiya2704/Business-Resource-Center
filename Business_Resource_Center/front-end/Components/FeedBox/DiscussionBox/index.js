    ...
    return (
      <div className={styles.container}>
        ...
        { !userProfile && <div className={styles.posterInfo}>
          ...
          <a target="_blank" href={`https://www.facebook.com/${userGitHandler}`} className={styles.gitHandler}>

            - <i className={classnames('fa fa-facebook-square', styles.gitIcon)}></i> {userName}
          </a>
        </div> }
