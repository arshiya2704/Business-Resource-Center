            ...
            <div className="row justify-content-md-center">
                <div className="col-md-6">
                    <form>
                        ...
                        <div className="form-group">
                            <input  label ="type" type="radio" name="Student" value="Student" onChange={this.onSiteChanged} /> Student
                            <input  label ="type" type="radio" name="Company" value="Company"/> Company<br></br>
                        </div>
                        <div className="form-group">
                            <button
